...
<form class="user" action="SvEditHora" method="POST">
    <div class="form-group col">

        <div class="col-sm-6 mb-3 mb-sm-2">
            <input type="text" class="form-control form-control-user" id="ini_hora"
                   placeholder="Inicio del horario" value="<%= horario.getHorario_inicio() %>" name="ini_hora">
        </div>

        <div class="col-sm-6 mb-3 mb-sm-2">
            <input type="text" class="form-control form-control-user" id="fin_hora"
                   placeholder="Fin del horario" value="<%= horario.getHorario_fin()%>" name="fin_hora">
        </div>
